...
const menuItems = [
  { label: 'Discover', hasDropdown: false },
  { label: 'Destinations', hasDropdown: true },
  { label: 'Plan Trip', hasDropdown: false },
...
export default function HeroNavbar() {
  return (
    <nav className="flex items-center justify-between py-6 px-6 md:px-10 w-full relative z-10">
      ...
      {/* Center Menu */}
      <ul className="hidden md:flex items-center gap-8 text-[rgb(45,45,45)] font-normal text-sm font-helvetica">
      ...
      <div className="md:hidden">
        <span className="font-helvetica tracking-tighter text-xl text-[rgba(30,50,90,0.9)]">
          SmartTravel
        </span>
      </div>
      ...
      <div className="flex-1 flex justify-end">
        <Link to="/register">
          ...
          >
            ...
            <span className="text-xs md:text-sm font-normal font-helvetica">
              Start Planning
            </span>
          </motion.button>
        </Link>
