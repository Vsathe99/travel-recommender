...
export default function BottomRightCorner() {
  return (
    ...
    >
      ...
      {/* Circle Icon */}
      <Link to="/login" className="flex items-center gap-3 sm:gap-4 md:gap-6 group">
        ...
        <div className="flex flex-col">
          <span className="text-[16px] md:text-[20px] font-normal text-[rgba(30,50,90,0.95)] font-helvetica">
            Get Started
          </span>
          <div className="flex items-center gap-1 text-[rgba(30,50,90,0.6)] cursor-pointer hover:text-[rgba(30,50,90,0.8)] transition-colors">
            <span className="text-[12px] md:text-[15px] font-normal font-helvetica">
              Sign In
            </span>
