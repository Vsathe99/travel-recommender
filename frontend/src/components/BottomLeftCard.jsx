  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col">
        <span className="text-2xl md:text-3xl font-normal text-[rgba(30,50,90,0.9)] tracking-tight font-helvetica">
          50+
        </span>
        <span className="text-[10px] md:text-[12px] font-normal text-[rgba(30,50,90,0.6)] uppercase tracking-wider font-helvetica">
          Destinations
        </span>
      </div>
      ...
      <Link to="/recommend">
        ...
        >
          ...
          <span className="text-[14px] font-normal text-[rgba(30,50,90,0.9)] font-helvetica">
            Explore Now
          </span>
        </motion.button>
      </Link>
